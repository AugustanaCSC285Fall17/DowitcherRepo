...
public class AlternativeSlideScreen implements Screen {
	 ...
	 * 
	 * @param game:
	 *            the final AdventureGame to store reference to StoryManager
	 *            Note: All fields in slides can potentially be null so needed
	 *            to check before displaying
	 */
	...
	public void render(float delta) {
		...
		game.batch.draw(image, AdventureGame.GAME_SCREEN_WIDTH - image.getWidth() - RIGHT_BUFFER,
				(AdventureGame.GAME_SCREEN_HEIGHT - image.getHeight()) / 2); // this
																				// centers
																				// the
																				// image
																				// height-wise
