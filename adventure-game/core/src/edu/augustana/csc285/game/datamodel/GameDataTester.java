...
public class GameDataTester {
	...
	public static void main(String[] args) {
		...
		familyHeirloom.addVisibleCondition(new ItemCondition(new Item("Family Heirloom", null, 1, 13, null), ConditionOperation.EQUAL));
		...
		sewingMachine.addVisibleCondition(new ItemCondition(new Item("Sewing Machine", null, 1, 14, null), ConditionOperation.EQUAL));
		...
		medicine.addVisibleCondition(new ItemCondition(new Item("Medicine", null, 1, 15, null), ConditionOperation.EQUAL));
		...
		curedMeat.addVisibleCondition(new ItemCondition(new Item("Cured Meat", null, 1, 16, null), ConditionOperation.EQUAL));
