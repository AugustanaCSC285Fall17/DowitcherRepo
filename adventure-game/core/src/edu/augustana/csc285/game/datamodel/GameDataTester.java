...
public class GameDataTester {
	...
	public static void main(String[] args) {
		...
		Item jDLetter = new Item("John Deere Letter", "A letter from John Deere", 1, 5, "GameData/SlideImages/item5.jpg");
		Item iLetter = new Item("Illinois Letter", "A letter from Illinois", 1, 6, "GameData/SlideImages/item6.jpg");
		Item wLetter = new Item("Washington Letter", "A letter from Washington", 1, 7, "GameData/SlideImages/item7.jpg");
		Item mLetter = new Item("Minnesota Letter", "A letter from Minnesota", 1, 8, "GameData/SlideImages/item8.jpg");
		...
		temp.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 20),ConditionOperation.GREATER_OR_EQUAL));
		...
		Slide s13 = new Slide("GameData/SlideImages/slide13.jpg", "You take a wagon to the port city of Gothenburg. You walk along Sillgatan or “Herring Street” where there were many emigrant agents, hotels, shops, and taverns. Here you wait to board a ship to England.", null, null, 13);
		s13.addOption(new Option("Continue", null, null, 14, null, null));
		
		Slide s14 = new Slide("GameData/SlideImages/slide14.jpg", "Over a million Swedish immigrants left through the port of Gothenburg in southwest Sweden. Many American genealogists believe their ancestors lived in Gothenburg, when really this was just the port they left through. Provinces of Sweden including Småland, Västergötland, Dalsland, Värmland, and Öland saw large numbers emigrate. ", null, null, 14);
		...
		Slide s15 = new Slide("GameData/SlideImages/slide15.jpg", "You see a market at the end of the lane. Do you wish to shop here?", null, null, 15);
		s15.addOption(new Option("Yes", null, null, 16, null, null));
		s15.addOption(new Option("No", null, null, 14, null, null));
		
		Slide s16 = new Slide("GameData/SlideImages/slide15.jpg", "Inspection After passing initial health inspection, the ticketmaster asks for your papers. Do you have your ticket?\n", null, null, 16);
		...
		Slide s17 = new Slide("GameData/SlideImages/slide15.jpg", "Ticket agent “What can I do for you?”", null, null, 17);
		Option buyHull = new Option("Pay for transport to Hull $15 or 60 SEK.\n", null, null, 14, null, null);
		Option buyHullAmerica = new Option("Pay for transport to Hull with connection to Liverpool and ship passage $30 or 120 SEK", null, null, 14, null, null);
		buyHull.addEffect(new ItemEffect(ticketToHull, EffectOperation.PLUS));
		buyHull.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 15), ConditionOperation.GREATER_OR_EQUAL));
		...
		buyHullAmerica.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 30), ConditionOperation.GREATER_OR_EQUAL));
		...
		buyBible.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 5), ConditionOperation.GREATER_OR_EQUAL));
		...
		buyFamilyHeirloom.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 5), ConditionOperation.GREATER_OR_EQUAL));
		...
		buySewingMachine.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 5), ConditionOperation.GREATER_OR_EQUAL));
		...
		buyMedicine.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 5), ConditionOperation.GREATER_OR_EQUAL));
		...
		buyCuredMeat.addFeasibleCondition(new PropertyCondition(new Property(PropertyType.GOLD, 5), ConditionOperation.GREATER_OR_EQUAL));
