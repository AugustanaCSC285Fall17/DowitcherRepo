...
public class Story {
	...
	public static void main(String[] args) {
		...
		Option johnDeereLetter = new Option("John Deere Letter",/* new Notification("You received the letter")*/null, null, "5", null, null);
		...
		Slide s15 = new Slide("GameData/SlideImages/slide15.jpg",
				"You see a market at the end of the lane. Do you wish to shop here?", null, "15");
		...
		Slide s17 = new Slide("GameData/SlideImages/slide15.jpg", "Ticket agent \"What can I do for you?\"", null,
				"17");
		...
		Slide s19 = new Slide("GameData/SlideImages/slide10.jpg", "Choose one item to buy", null, "19");
