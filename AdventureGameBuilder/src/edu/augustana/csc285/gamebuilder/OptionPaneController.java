...
import edu.augustana.csc285.game.datamodel.effect.GenderEffect;
import edu.augustana.csc285.game.datamodel.effect.ItemEffect;
import edu.augustana.csc285.game.datamodel.effect.NameEffect;
import edu.augustana.csc285.game.datamodel.effect.PropertyEffect;
public class OptionPaneController {

	private int currentOptionIndex;
	private Option currentOption;
    @FXML private ComboBox optionBox;
    @FXML private Button optionAddButton;
    @FXML private Button optionRemoveButton;
    ...
    @FXML private ComboBox conditionBox;
    @FXML private Button conditionAddButton;
    @FXML private Button conditionRemoveButton;
    @FXML private Button conditionTypeBox;
    
    private ArrayList<Effect> effects;
    @FXML private ComboBox effectBox;
    @FXML private Button effectAddButton;
    @FXML private Button effectRemoveButton;
    @FXML private ChoiceBox effectTypeBox;
